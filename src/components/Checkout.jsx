    ...
    return (
        <div className="container">
            ...
            <div className="row">
                <div className="col-md-6">
                    <form>
                        ...
                        <button type="button" className="btn btnComprar" onClick={generarOrden}>Generar Orden</button>
                    </form>
                </div>
            ...
            <div className="row my-5">
                <div className="col text-center">
                    {orderId ? <div class="alert styleOrdenGenerada p-5 text-center" role="alert">
